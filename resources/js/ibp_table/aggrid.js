...
export let agGridParameters = {
    ...
    buildingAndOuterEquipParameters: {
        gridOptions: {
            ...
            columnDefs: [
                ...
                {
                    headerName: "Выпуск",
                    field: "year_issue_date",
                    tooltipField: 'year_issue_date',
    ...
    buildingOuterEquipKapRemontParameters: {
        gridOptions: {
            domLayout: 'autoHeight',
            columnDefs: [
    ...
    buildingOuterEquipTehnObslRemontParameters: {
        gridOptions: {
            domLayout: 'autoHeight',
            columnDefs: [
                {headerName: "Объект", field: "place_first_lev", tooltipField: 'place_third_lev'},
    ...
    buildingOuterEquipPenRenParameters: {
        gridOptions: {
            domLayout: 'autoHeight',
            columnDefs: [
                {headerName: "Объект", field: "place_first_lev", tooltipField: 'place_third_lev'},
    ...
    buildingOuterEquipTroParameters: {
        gridOptions: {
            domLayout: 'autoHeight',
            columnDefs: [
                {headerName: "Объект", field: "place_first_lev", tooltipField: 'place_third_lev'},
